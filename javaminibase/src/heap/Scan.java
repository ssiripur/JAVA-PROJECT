...
public class Scan implements GlobalConst {
	...
	private boolean firstDataPage() throws InvalidTupleSizeException,
		...
		/**
		 * ASSERTIONS: - first directory page pinned - this->dirpageId has Id of
		 * first directory page - this->dirpage valid - if heapfile empty: -
		 * this->datapage == NULL, this->datapageId==INVALID_PAGE - if heapfile
		 * nonempty: - this->datapage == NULL, this->datapageId,
		 * this->datapageRid valid - first datapage is not yet pinned
		 */
