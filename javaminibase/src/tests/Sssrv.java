...
public class Sssrv {
	...
	private static void topNestedLoopJoinsTest() { // DONE
		try {
			...
			PCounter.initialize();
			TopNestedLoopsJoins top_nested = new TopNestedLoopsJoins(
	...
	private static void topRankJoinTest() {
		try {
			...
			PCounter.initialize();
			TopRankJoin top_rank = new TopRankJoin(numTables, attrslist,
					attrslistlengths, stringsizes, joincolumns, iterators,
