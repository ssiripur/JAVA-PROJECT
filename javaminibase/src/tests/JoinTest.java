...
class JoinsDriver implements GlobalConst {
	...
	public JoinsDriver() {
		...
		sailors.addElement(new Sailor(53, "Bob Holloway", 9, 53.6,0.3f));
		sailors.addElement(new Sailor(54, "Susan Horowitz", 1, 34.2,0.3f));
		sailors.addElement(new Sailor(57, "Yannis Ioannidis", 8, 40.2,0.3f));
		sailors.addElement(new Sailor(59, "Deborah Joseph", 10, 39.8,0.3f));
		sailors.addElement(new Sailor(61, "Landwebber", 8, 56.7,0.3f));
		sailors.addElement(new Sailor(63, "James Larus", 9, 30.3,0.3f));
		sailors.addElement(new Sailor(64, "Barton Miller", 5, 43.7,0.3f));
		sailors.addElement(new Sailor(67, "David Parter", 1, 99.9,0.3f));
		sailors.addElement(new Sailor(69, "Raghu Ramakrishnan", 9, 37.1,0.3f));
		sailors.addElement(new Sailor(71, "Guri Sohi", 10, 42.1,0.3f));
		sailors.addElement(new Sailor(73, "Prasoon Tiwari", 8, 39.2,0.3f));
		sailors.addElement(new Sailor(39, "Anne Condon", 3, 30.3,0.3f));
		sailors.addElement(new Sailor(47, "Charles Fischer", 6, 46.3,0.3f));
		sailors.addElement(new Sailor(49, "James Goodman", 4, 50.3,0.3f));
		sailors.addElement(new Sailor(50, "Mark Hill", 5, 35.2,0.3f));
		sailors.addElement(new Sailor(75, "Mary Vernon", 7, 43.1,0.3f));
		sailors.addElement(new Sailor(79, "David Wood", 3, 39.2,0.3f));
		sailors.addElement(new Sailor(84, "Mark Smucker", 9, 25.3,0.3f));
		sailors.addElement(new Sailor(87, "Martin Reames", 10, 24.1,0.3f));
		sailors.addElement(new Sailor(10, "Mike Carey", 9, 40.3,0.1f));
		sailors.addElement(new Sailor(21, "David Dewitt", 10, 47.2,0.9f));
		sailors.addElement(new Sailor(29, "Tom Reps", 7, 39.1,0.3f));
		sailors.addElement(new Sailor(31, "Jeff Naughton", 5, 35.0,0.3f));
		sailors.addElement(new Sailor(35, "Miron Livny", 7, 37.6,0.3f));
		sailors.addElement(new Sailor(37, "Marv Solomon", 10, 48.9,0.3f));

		boats.addElement(new Boats(1, "Onion", "white",0.8f));
		boats.addElement(new Boats(2, "Buckey", "red",0.8f));
		boats.addElement(new Boats(3, "Enterprise", "blue",0.8f));
		boats.addElement(new Boats(4, "Voyager", "green",0.8f));
		boats.addElement(new Boats(5, "Wisconsin", "red",0.8f));

		reserves.addElement(new Reserves(10, 1, "05/10/95",0.7f));
		reserves.addElement(new Reserves(10, 3, "05/13/95",0.7f));
		reserves.addElement(new Reserves(10, 2, "05/11/95",0.7f));
		reserves.addElement(new Reserves(21, 1, "05/11/95",0.7f));
		reserves.addElement(new Reserves(31, 1, "05/12/95",0.7f));
		reserves.addElement(new Reserves(69, 4, "05/12/95",0.7f));
		reserves.addElement(new Reserves(69, 5, "05/14/95",0.7f));
		reserves.addElement(new Reserves(21, 5, "05/16/95",0.7f));
		reserves.addElement(new Reserves(57, 2, "05/10/95",0.7f));
		reserves.addElement(new Reserves(35, 3, "05/15/95",0.7f));
		...
		for (int i = 0; i < numboats; i++) {
			try {
				...
				t.setScore((float) ((Boats) boats.elementAt(i)).score);
		...
		for (int i = 0; i < numreserves; i++) {
			try {
				...
				t.setScore((float) ((Reserves) reserves.elementAt(i)).score);
...
//		Query6();
	...
	public void Query2() {
		...
		TopNestedLoopsJoins nlj1 = null;
		try {
			
			nlj1 = new TopNestedLoopsJoins(Stypes2, 2, Ssizes, Rtypes, 3, Rsizes,
					10, am, "reserves.in", outFilter, null, proj1, 2,5);
		...
		// newly added code which displays the result of topnestedloop join
		Tuple p =null;
		try{
		    
		
		    while((p=nlj1.get_next())!=null)
		    {
		        System.out.println("The name is"+p.getScore());
		        p.print(Jtypes);
		    }
		    
		    //System.out.println(""+performance.getBufferSize(mgr)+performance.getCurrentPage(ib))
		}
		catch(Exception e)
		{
		...
		try {
			sort_names = new Sort(JJtype , (short) 2, JJsize,
					(iterator.Iterator) nlj, 1, ascending, 30, 10);
		} catch (Exception e) {
			System.err.println("*** Error preparing for nested_loop_join");
			System.err.println("" + e);
			Runtime.getRuntime().exit(1);
