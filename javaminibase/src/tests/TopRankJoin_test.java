...
public class TopRankJoin_test extends TestDriver {
    ...
    public void testTopRankJoin() throws JoinsException, IndexException, InvalidTupleSizeException, InvalidTypeException, PageNotReadException, TupleUtilsException, PredEvalException, SortException, LowMemException, UnknowAttrType, UnknownKeyTypeException, IOException, Exception {
        ...
        FldSpec[] boatsplusProjection = new FldSpec[4];
        boatsplusProjection[0] = new FldSpec(new RelSpec(RelSpec.outer), 1);
        boatsplusProjection[1] = new FldSpec(new RelSpec(RelSpec.outer), 2);
        boatsplusProjection[2] = new FldSpec(new RelSpec(RelSpec.outer), 3);
        boatsplusProjection[3] = new FldSpec(new RelSpec(RelSpec.outer), 4);
        
        FldSpec[] boatsminusProjection = new FldSpec[4];
        boatsminusProjection[0] = new FldSpec(new RelSpec(RelSpec.outer), 1);
        boatsminusProjection[1] = new FldSpec(new RelSpec(RelSpec.outer), 2);
        boatsminusProjection[2] = new FldSpec(new RelSpec(RelSpec.outer), 3);
        boatsminusProjection[3] = new FldSpec(new RelSpec(RelSpec.outer), 4);
        ...
        FldSpec[] reservesplusProjection = new FldSpec[4];
        reservesplusProjection[0] = new FldSpec(new RelSpec(RelSpec.outer), 1);
        reservesplusProjection[1] = new FldSpec(new RelSpec(RelSpec.outer), 2);
        reservesplusProjection[2] = new FldSpec(new RelSpec(RelSpec.outer), 3);
        reservesplusProjection[3] = new FldSpec(new RelSpec(RelSpec.outer), 4);
        
        FldSpec[] reservesminusProjection = new FldSpec[4];
        reservesminusProjection[0] = new FldSpec(new RelSpec(RelSpec.outer), 1);
        reservesminusProjection[1] = new FldSpec(new RelSpec(RelSpec.outer), 2);
        reservesminusProjection[2] = new FldSpec(new RelSpec(RelSpec.outer), 3);
        reservesminusProjection[3] = new FldSpec(new RelSpec(RelSpec.outer), 4);
        ...
        IndexType []type=new IndexType[6];
        IndexType b_index = new IndexType(IndexType.B_Index);
        type[0]=b_index;
        type[1]=new IndexType(IndexType.B_Index);
        type[2]=new IndexType(IndexType.B_Index);
        type[4]=new IndexType(IndexType.B_Index);
        type[5]=new IndexType(IndexType.B_Index);
        ...
        try {
            ...
            sm[1] = new FileScan( "boatsplus.in", attrTypes[0],
                    strSizes[0], (short)4, 4, boatsplusProjection, null);
            Tuple newTup = sm[1].get_next();
            System.out.println("t1: "+newTup.getIntFld(1));
            System.out.println("t4: "+ newTup.getFloFld(4));
        ...
        try {
            sm[2] = new FileScan( "boatsminus.in", attrTypes[0],
                    strSizes[0], (short)4, 4, boatsminusProjection, null);
            Tuple newTup = sm[2].get_next();
            System.out.println("t1: "+newTup.getIntFld(1));
            System.out.println("t4: "+ newTup.getFloFld(4));
        ...
        try {
            ...
            Tuple newTup = sm[3].get_next();
            System.out.println("from reserves table");
            System.out.println("t1: "+newTup.getIntFld(1));
          //  System.out.println("t4: "+ newTup.getFloFld(4));
        ...
        try {
            sm[4] = new FileScan("reservesplus.in", attrTypes[1],
                    strSizes[1], (short)4, 4, reservesplusProjection, null);
        ...
        try {
            sm[5] = new FileScan("reservesminus.in", attrTypes[1],
                    strSizes[1], (short)4, 4, reservesminusProjection, null);
...
//}
        ...
        Filescan2 f2=new Filescan2(2,attrTypes,len_in,strSizes,joinColumnIndex,am,type,indexNames,relNames,10,outFilter,projection,6,3);
...
//		}
    ...
    public static void main(String[] args) throws JoinsException, IndexException, InvalidTupleSizeException, InvalidTypeException, PageNotReadException, TupleUtilsException, PredEvalException, SortException, LowMemException, UnknowAttrType, UnknownKeyTypeException, IOException, Exception {
        ...
        TopRankJoin_test test = new TopRankJoin_test();
        test.runAllTests();
