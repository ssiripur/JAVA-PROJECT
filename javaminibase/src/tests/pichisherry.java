...
//			outFilter[1] = null;
//			int i ;
//			FldSpec[] proj_list=new FldSpec[csv1.get_attrs().length];
//			for ( i = 0; i < csv1.get_attrs().length; i++) {
...
//				
//			}
//			System.out.println("Size of numflds"+Sprojection.length);
//			
//
//			PCounter.initialize();
//			 //NestedLoopJoinTop nlj=new ;
//			
...
//					proj_list, proj_list.length, k);
//			
//			
////			TopNestedLoopJoinExcl(AttrType[] in1, int len_in1,
...
//	         
//	         try {
//	           while ((t1 = top_nested.get_TopRanked()) != null) {
//	             //t.print(jtype);
//	             
//	             //qcheck1.Check(t);
//	           }
...
//			PCounter.initialize();
//			AttrType[] attr=csv1.get_attrs();
////			for(int i=0;i<csv1.get_attrs().length;i++)
////			{
////				System.out.println(attr[i].attrType);
////			}
//			
...
//			for(int i=0;i<numTables;i++)
//			{
//				iter[i] = new Sort(attrslist[i],(short)attrslistlengths[i],stringsizes[i], iterators[i], attrslistlengths[i],
//						  new TupleOrder(TupleOrder.Descending),4,30);
//			}
//			
...
////        			int n_out_flds, int num) throws HFException, HFBufMgrException,
////
