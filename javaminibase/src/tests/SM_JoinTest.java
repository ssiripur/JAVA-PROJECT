...
//	public double score;
//
//	public Reserves(int _sid, int _bid, String _date, double _score) {
//		sid = _sid;
//		bid = _bid;
//		date = _date;
//		score = _score;
...
//
//		System.out.println("-- CALLING SORT MERGE --");
//		TupleOrder ascending = new TupleOrder(TupleOrder.Ascending);
//		TopSortMerge sm = null;
//		try {
//			sm = new TopSortMerge(Stypes, 4, Ssizes, Rtypes, 3, Rsizes, 1, 4,
//					1, 4, 10, am, am2, false, false, ascending, outFilter,
//					proj_list, 2, 3);
//		} catch (Exception e) {
...
//sm.get_topK();
////		try {
////			while(sm.get_topK()!=null);//while ((t = sm.get_topK()) != null) {
////				////t.print(jtype);
////
////				qcheck1.Check(t);
////			}
