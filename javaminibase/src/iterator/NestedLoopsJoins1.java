...
public class NestedLoopsJoins1  extends Iterator 
{
   ...
   */
  public NestedLoopsJoins1( AttrType    in1[],    
			   int     len_in1,           
			   short   t1_str_sizes[],
			   AttrType    in2[],         
			   int     len_in2,           
	      ...
	      while ((inner_tuple = inner.getNext(rid)) != null)
		{
		  ...
		  if (PredEval.Eval(RightFilter, inner_tuple, null, _in2, null) == true)
		      ...
		      if (PredEval.Eval(OutputFilter, outer_tuple, inner_tuple, _in1, _in2) == true)
			{
			  ...
			  t1=outer_tuple.getFloFld(in1_len);
			  t2=inner_tuple.getFloFld(in2_len);
			  t1=(t1+t2)/2;
			  Jtuple.setFloFld(nOutFlds, t1);
//			  Jtuple.getFloFld(nOutFlds);
//			  Jtuple.
			  return Jtuple;
			}
		    }
