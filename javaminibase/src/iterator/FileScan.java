...
public class FileScan extends Iterator {
	...
	public FileScan(String file_name, AttrType in1[], short s1_sizes[],
			...
			CondExpr[] outFilter) throws IOException, FileScanException,
		...
		try {
			...
			System.err.println("Error in filescan");
	 ...
	 */
	public Tuple get_next() throws JoinsException, IOException,
