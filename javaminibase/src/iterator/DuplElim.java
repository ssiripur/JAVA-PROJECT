...
public class DuplElim extends Iterator
{
  ...
  public Tuple get_next() 
    ...
    // TempTuple1.tupleCopy(TempTuple2);
      ...
      /** Modify duplicate elimination, such that the scores of all duplicate tuples are artithmetic averaged and in the
       output
       */
      // Modified by Siddarth Polisetty
      float value=(TempTuple1.getScore()+TempTuple2.getScore())/2;
