 ...
 */
public class SortMerge1 extends Iterator implements GlobalConst
{
   ...
   */
  public SortMerge1(AttrType    in1[],               
		   int     len_in1,                        
		   short   s1_sizes[],
		   AttrType    in2[],                
		   int     len_in2,                        
	  ...
	  if (PredEval.Eval(OutputFilter, TempTuple1, TempTuple2, _in1, _in2) == true)
	    {
	     ...
	     score1=TempTuple1.getFloFld( in1_len);
	     System.out.println(score1);
	     score2=TempTuple2.getFloFld(in2_len);
	     System.out.println(score2);
	     score1=(score1+score2)/2;
	     Jtuple.setFloFld(nOutFlds, score1);
	    Jtuple.setScore(score1);
